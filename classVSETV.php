    ...
    if (@file_exists($this->CACHEDIR.$this->channel.'.'.$this->prog_date))  {
     $this->isCached=true;
      ...
      if ($this->LoadNextDateTailFunc) {$this->LoadNextDateTail();}
       ...
       $this->GetChannelURL();
       if ($this->ChannelURL=='') {$this->Content='';return $this->Content;}
      ...
      $cont = str_replace('<img src="/pic/e7.gif">', "0", $cont);
      $cont = str_replace('<img src="/pic/p4.gif">', "5", $cont);
      ...
      if ($try_counter<2)  {
       ...
       $timeshift=86400;
        ...
        $t = $temp->getTimestamp();
         ...
         if ($this->LoadNextDateTailFunc) {
         if ($this->Content=="") $void='"VOID" '; else $void='';
         }
       return $this->Content;
     }
