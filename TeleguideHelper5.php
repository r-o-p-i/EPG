...
$REG = 40005;
$SCRIPT = 'TeleguideHelper5.php';
$Title = 'TELEMAN';
$CACHEDIR = $_SERVER['DOCUMENT_ROOT'] . $CURDIR . 'PROGCACHE_TELEMANTV/';
...
if (isset($_POST['channel'])) {
  $Logo = "http://" . $_SERVER['SERVER_NAME'] . $CURDIR . "/LOGOS/tman/" . $channels[$_POST['channel']][2] . ".png";
  if (isset($Logo)) {
  ...
  $cont3 = "";
  if ($age_restr == 1) {
    $Teleguide = new classTELEMANTV($channels[$_POST['channel']][2], -1, true);
  } else {
    $Teleguide = new classTELEMANTV($channels[$_POST['channel']][2], -1, false);
  }
  $cont3 = $Teleguide->Get();
