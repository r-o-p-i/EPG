...
if (isset($_POST['channel'])) {
  $Logo = "http://" . $_SERVER['SERVER_NAME'] . $CURDIR . "LOGOS/dutch/" . $channels[$_POST['channel']][2] . ".png";
  if (isset($Logo)) {
  ...
  $cont3 = "";
  if ($age_restr == 1) {
    $Teleguide = new classsPielfilm($channels[$_POST['channel']][2], -1, true);
  } else {
    $Teleguide = new classsPielfilm($channels[$_POST['channel']][2], -1, false);
  }
  $cont3 = $Teleguide->Get();
